<template>
  <div id="player">
    ...
    <div class="playContext-btnBox">
      <span>
        <i class="iconfont icon-playType"></i>
      </span>
      <span @click="goPrevSongs">
        <i class="iconfont icon-forward"></i>
      </span>
      <span>
        <i class="iconfont" :class="{'icon-pause':playStatus == true, 'icon-play':playStatus == false}" @click="togglePlayStatus"></i>
      </span>
      <span @click="goNextSongs">
        <i class="iconfont icon-forward"></i>
      </span>
      <span @click="openSongList">
